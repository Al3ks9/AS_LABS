...
def train_loop(env_name="LunarLander-v3", episodes=500):
    ...
    for ep in trange(episodes):
        ...
        while not done:
            ...
            # Reward shaping: bonus if both legs are down and action is shut off engine
