...
def preprocess_frame(frame):
    ...
    return torch.FloatTensor(normalized_frame).unsqueeze(0)  # Add channel dimension
...
def train_dqn(episodes=1000):
    ...
    policy_net = DQN(input_shape, output_dim)
    target_net = DQN(input_shape, output_dim)
...
def test_dqn(model_path, episodes=10, render=False):
    ...
    policy_net = DQN((1, 84, 84), 9)  # Adjust input/output dimensions as needed
